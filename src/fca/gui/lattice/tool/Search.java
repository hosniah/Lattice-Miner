 ...
 * selection dans le but de faire une opération de recherche qui sera affichée
 * dans le LatticeViewer associé.
 * 
...
public abstract class Search extends JPanel implements ActionListener {
	 ...
	 *            attributs et objets
	 * @param lp
	 *            Le {@link LatticePanel} dans lequel est affiché le treillis
	 */
	...
	/**
	 * Retourne le concept qui correspond à la recherche exacte sur les
	...
	/**
	 * Retourne le treillis ou le concept qui correspond à la recherche
	 * approximative sur les attributs et objets sélectionnés
	 * 
	...
	public void actionPerformed(ActionEvent e) {
		...
		// Bouton d'exécution de l'approximation OU une case a été cochée et
		// approximation "a la volée" actif
