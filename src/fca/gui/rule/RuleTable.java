...
public class RuleTable extends JTable implements MouseListener {
	...
	//private static Color SELECTION_COLOR = new Color(225, 233, 252);
	...
	public void setRuleTable(Vector<Rule> rules){
		...
		// TODO Implementer l'affichage de la mesure de lift		
...
//				String labelValue = getModel().getValueAt(row, convertColumnIndexToModel(column)).toString();
//				
//				JButton cellBtn = new JButton(labelValue);
//				cellBtn.setBorderPainted(false);
//				
//				if (row == thisTable.getSelectedRow())
//					cellBtn.setBackground(SELECTION_COLOR);
//				else 
//					if (row % 2 == 0)
//					cellBtn.setBackground(Color.WHITE);
//				else
//					cellBtn.setBackground(YELLOW);
//				
