...
public class ValuedContext extends Context {
	...
	public ValuedContext(String name, int objCnt, int attCnt) {
		...
		/* Initialement, chaque attribut n'a que des valeurs non numériques ("") */
		numberAttributeValueFlags = new Vector<Integer>();
	...
	public void setValueAt(String val, String obj, String att) throws InvalidTypeException {
		...
		if (objIdx > -1 && attIdx > -1) {
			if (val == null)
				...
				/*
				 * Ajustement de l'indicateur de valeur non numérique pour l'attribut de la relation
				 * ciblée
				 */
				String oldValue = getValueAt(objIdx, attIdx);
				int numCount = numberAttributeValueFlags.elementAt(attIdx).intValue();
	...
	/**
	 * Supprime l'attribut à la position donnée
	 * @param attIdx Le int contenant la position de l'attribut à supprimer
	 */
	...
	/**
	 * Supprime l'attribut donné
	 * @param att La String contenant la nom de l'attribut à supprimer
	 */
	@Override
	...
	/**
	 * Permet d'obtenir l'ensemble (sans répétition) des valeurs possédées par l'attibut à la
	 * position donnée
	 * @param attIdx Le int contenant la position de l'attribut recherché
	 * @return Le TreeSet contenant l'ensemble des valeurs pour l'attribut recherché
	 */
	...
	/**
	 * Convertit ce contexte valué en un contexte binaire
	 * @param model Le ValuedContextConversionModel qui contient les règles de conversion de ce
	 *        contexte
	 * @return Le BinaryContext créé suite à la conversion
	 */
	...
	/**
	 * Convertit cette relation valuée en plusieurs relations binaires
	 * @param model Le ValuedContextConversionModel qui contient les règles de conversion de ce
	 *        contexte
	 * @return Le Vector de BinaryContext créé suite à la conversion
	 */
	@SuppressWarnings("unchecked") //$NON-NLS-1$
	// getNewAttributeValues non type
	public Vector<BinaryContext> convertToBinaryContexts(ValuedContextConversionModel model) {
		...
		/* Création des relations binaires */
		for (int oldAttIdx = 0; oldAttIdx < attributes.size(); oldAttIdx++) {
	...
	/**
	 * Permet de savoir si un attribut contient des valeurs qui sont toutes numériques ou non
	 * @param att La String de l'attribut pour lequel on veut connaître le type de valeurs
	 * @return Le boolean indiquant si les valeurs de l'attribut sont toutes numériques
	 */
	...
	/**
	 * Permet de savoir si un attribut contient des valeurs qui sont toutes numériques ou non
	 * @param attIdx Le int contenant la position de l'attribut pour lequel on veut connaître le type de
	 *        valeurs
	 * @return Le boolean indiquant si les valeurs de l'attribut sont toutes numériques
	 */
	...
	/**
	 * Permet de savoir si la valeur contenue dans une chaîne est un entier
	 * @param value La String contenant la valeur à vérifier
	...
	/**
	 * Permet de savoir si la valeur contenue dans une chaîne est un nombre à virgule
	 * @param value La String contenant la valeur à vérifier
	 * @return Le boolean indiquant si la valeur est un nombre à virgule
	 */
